...
Hanoi_status::Hanoi_status() {
  ...
  this->n[1] =
  this->n[2] = 0;
  stack[0].resize(this->N);
  stack[1].resize(this->N);
  stack[2].resize(this->N);
  std::fill( this->stack[0].begin(), this->stack[0].end(), 0 );
  std::fill( this->stack[1].begin(), this->stack[1].end(), 0 );
  std::fill( this->stack[2].begin(), this->stack[2].end(), 0 );
}
...
Hanoi_status::move( int from, int to, int & dm ) {
  ...
  std::vector<int> & Sf = this->stack[from-1]; // alias di this->stack[from-1]
  std::vector<int> & St = this->stack[to-1];   // alias di this->stack[to-1]
  if ( nf == 0 ) {
